...
public:
	...
	static BeebWin* instanceReference; // Stores the instance reference Alex Soca 06/04/2025

	void SetBeebWin(); // Sets the BeebWin instance pointer Alex Soca 06/04/2025
	static BeebWin* GetBeebWin(); // Gets the BeebWin instance pointer Alex Soca 06/04/2025

	bool Initialise();
	void ApplyPrefs();
	void ApplyCustomConfiguration(); // Alex Soca 25/02/2025 Custom BeebEm Configuration
	void Shutdown();
