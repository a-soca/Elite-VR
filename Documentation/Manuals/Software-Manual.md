...
> To Build and Run the Project, follow the instructions in [this section](#building-and-running-elite-vr)
...
| [Building and Running Elite VR](#building-and-running-elite-vr)        |
...
- Navigate to the folder in the repository `Unity-Project/Build` and confirm

### Building and Running Elite VR
- To run Elite VR, you must first [Compile BeebEm](#compiling-the-elite-vr-custom-beebem-fork) and [Build the Unity project](#building-the-unity-project). For a debug build, run `Generate-Debug.bat` from the repository root. Otherwise, run `Generate-Release.bat` from the repository root. If the components have been compiled in the correct locations, a new folder containing the build will be generated in the repository root.
